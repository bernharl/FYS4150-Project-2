...
\begin{figure*}[h]
	...
	\label{fig:rhomax}
\end{figure*}
For the two electrons in a harmonic oscillator potential ,as described in section \ref{sec:SEtwoelectron}, the first eigenstate was plotted as a function of $\rho$ for varying degree of the potential strength $\omega_r$.  This is shown in figure \ref{fig:eigenstates}.
\begin{figure*}[h]
